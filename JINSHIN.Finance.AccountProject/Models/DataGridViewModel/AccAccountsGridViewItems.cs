...
{
    public class AccAccountsGridViewItems :JBase
    {
        public List<NameValues> columns { get; set; }
        public AccAccountsGridViewItems()
        {
            columns = new List<NameValues>();
       //     columns.Add(new NameValues() { name = "sn", value = "Text", text = "序號",hidden=true });
       ...
       //     columns.Add(new NameValues() { name = "item", value = "Text", text = "項目" });
            ...
            columns.Add(new NameValues() { name = "sell_id", value = "Text", text = "銷售人統編" });
            columns.Add(new NameValues() { name = "buy_id", value = "Text", text = "購買人統編" });
